...
(
    ...
    CONSTRAINT CHK_CLIENT_AUTH_METHODS_VALUES CHECK (
        ...
        '^(client_secret_basic|client_secret_post|private_key_jwt|client_secret_jwt|none)(,(client_secret_basic|client_secret_post|private_key_jwt|client_secret_jwt|none))*$'
        ),
    CONSTRAINT CHK_AUTHORIZATION_GRANT_TYPES_VALUES CHECK (
        AUTHORIZATION_GRANT_TYPES ~
        '^(authorization_code|client_credentials|refresh_token|urn:ietf:params:oauth:grant-type:device_code|urn:ietf:params:oauth:grant-type:token-exchange)(,(authorization_code|client_credentials|refresh_token|urn:ietf:params:oauth:grant-type:device_code|urn:ietf:params:oauth:grant-type:token-exchange))*$'
        )
);